package com.pscodes.trafficprediction.common.feeds

import com.pscodes.trafficprediction.common.config.Configuration
import com.pscodes.trafficprediction.common.feeds.io.{CSVFeedIO, FeedIO, ParquetFeedIO}
...
object Feed {
  ...
  def apply[T](feedIO: FeedIO[T], path: String): Feed[T] = {
    val feedPath = Configuration().FeedsRootPath + path
